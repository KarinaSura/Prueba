...
<div id="templatemo_menu_panel">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de libros educativos.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>
             
             <div class="product_box">
              <h3>Oceano Gramática práctica</h3>
                <img src="portadas/0132.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>¡Auxilio! Para un excelente maestro...</h3>
                <img src="portadas/0163.jpg" alt="image" width="200px" height="250px" /></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Escuela de seguridad infantil</h3>  
                <img src="portadas/0174.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
