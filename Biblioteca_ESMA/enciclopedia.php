...
<div id="templatemo_menu_panel">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de enciclopedias.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>
             
             <div class="product_box">
              <h3>La biblioteca y formacion de lectores</h3>
                <img src="portadas/0017.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>El mundo de la computacion</h3>
                <img src="portadas/0001.jpg" alt="image" width="200px" height="250px" /></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Gran enciclopedia universal</h3>  
                <img src="portadas/0068.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
