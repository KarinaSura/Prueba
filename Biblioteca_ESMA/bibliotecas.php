...
<div id="templatemo_menu_panel">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de libros sobre bibliotecas.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>

             <div class="product_box">
              <h3>La biblioteca en el medio rural</h3>
                <img src="portadas/0005.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>

             <div class="product_box">
              <h3>La biblioteca de aula infantil</h3>
                <img src="portadas/0008.jpg" alt="image" width="200px" height="250px" /></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>

             <div class="product_box">
              <h3>Actividades de dinamización desde la biblioteca escolar</h3>  
                <img src="portadas/0009.jpg" alt="image" width="200px" height="250px" /></br>
