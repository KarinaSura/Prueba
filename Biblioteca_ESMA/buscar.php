...
var borrar = confirm("Est�s seguro/a de que quiere eliminar estos registros?"); 
...
<ol>
  ...
  <li><label>A�o: </label><input type="text"  value="<?php echo $a�o; ?>" name="ao" size="25" style="background:#F3FCFF"/></li>
...
$des=$_POST["ao"];
  ...
  $desc="UPDATE libros SET a�o='$des' WHERE titulo_libro='$identi'";
           mysql_query($desc);
