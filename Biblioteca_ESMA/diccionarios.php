...
<div id="templatemo_menu_panel">
        <ul>
            ...
            <li><a href="galeria.phpc" target="_parent">GALERIA</a></li>  
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de diccionarios.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>
             
             <div class="product_box">
              <h3><br>Diccionario de psicologia y pedagogia</h3>
                <img src="portadas/0078.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Diccionario de las Ciencias de la educación</h3>
                <img src="portadas/0076.jpg" alt="image" width="200px" height="250px" /></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Océano Uno Color Diccionario enciclopédico</h3>  
                <img src="portadas/0098.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
