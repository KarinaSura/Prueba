...
<div id="templatemo_menu_panel">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de guias.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>
             
             <div class="product_box">
              <h3>Guía de la bilblioteca. Funciones y actividades</h3>
                <img src="portadas/0002.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3><br>Guía práctica de la biblioteca escolar</h3>
                <img src="portadas/0003.jpg" alt="image" width="200px" height="250px" /></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3><br>Guía de bibliotecas públicas españolas</h3>  
                <img src="portadas/0022.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
