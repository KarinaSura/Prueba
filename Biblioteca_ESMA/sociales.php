          ...
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de libros sociales.</p>
             ...
             <div class="product_box">
              <h3>Atlas del cuerpo humano</h3>
                <img src="portadas/0156.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Disciplina en el aula</h3> </br>  
                <img src="portadas/0168.jpg" alt="image" width="200px" height="250px"/></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>Escuela para padres</h3> <br> 
                <img src="portadas/0171.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
