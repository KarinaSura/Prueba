...
<div id="templatemo_menu_panel">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_content_left">
          <h1>Informatica</h1>
            <p>La biblioteca virtual de ESMA te ofrece una gran variedad de libros sociales.</p>
                        
             <div class="cleaner_with_height">&nbsp;</div>
             
             <div class="product_box">
              <h3>1000 Plantas medicinales, aromáticas y culinarias</h3>
                <img src="portadas/0151.jpg" alt="image" width="200px" height="250px" /></br>
                     </br>                     
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>1000 Trucos para sentirse bien</h3> </br>  
                <img src="portadas/0152.jpg" alt="image" width="200px" height="250px"/></br>
                  </br>                         
              <div class="prestar"><a href="prestamos.php">Prestar</a></div><a href="#"></a>
             </div>
             <div class="product_box">
              <h3>1000 Trucos para esta en forma</h3> <br> 
                <img src="portadas/0153.jpg" alt="image" width="200px" height="250px" /></br>
                 </br> 
